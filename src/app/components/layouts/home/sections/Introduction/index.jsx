...
const Introduction = () => {
  return (
    <>
      <div className="  grid grid-cols-1 text-center mt-4 mx-4  ">
        ...
        <div className=" mt-4  backdrop-blur-sm bg-green-400/30 flex flex-row text-xs text-center items-center p-2 px-2 border-t-8 border-t-green-700 border-l-8 border-l-green-700 border-r-8 border-r-white border-b-8 border-b-white rounded-sm shadow-lg">
          <p>
