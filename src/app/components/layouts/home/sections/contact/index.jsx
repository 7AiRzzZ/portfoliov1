...
const Contact = () => {
  return (
    <>
      ...
      <div className=" backdrop-blur-sm bg-green-400/30  border-t-8 border-t-green-700 border-l-8 border-l-green-700 border-r-8 border-r-white border-b-8 border-b-white rounded-sm shadow-lg flex flex-row justify-center mx-2 mb-2 pt-4">
        <form action="">
